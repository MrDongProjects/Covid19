layui.use([ 'form','layer','jquery','table','laydate'], function() {
	...
	table.render({
	    ...
	    ,cols: [[ // 表头
          ...
          ,{field:'birthday', title: '出生日期' , align: 'center',templet : '<div>{{ formatTime(d.birthday,"yyyy-MM-dd")}}</div>',width:110}
          ,{field:'phone', title: '电话', align: 'center' ,width:120}
          ,{field:'email', title: '邮箱' , align: 'center',width:180}
          ,{field:'status', title: '体温', width:80, templet : '#statusTpl',width:95, align: 'center'}
          ,{field:'roleId', title: '健康状况' , align: 'center', templet : '#levelTpl',width:135}
          ,{field:'createTime', title: '外出时间' , align: 'center',templet : '<div>{{ formatTime(d.createTime,"yyyy-MM-dd hh:mm:ss")}}</div>' ,width:170}

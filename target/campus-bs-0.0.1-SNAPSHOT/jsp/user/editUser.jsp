		...
		<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<select name="roleId">
						<option value="21" <c:if test="${user.roleId==21}">selected</c:if>>健康</option>
						<option value="22" <c:if test="${user.roleId==22}">selected</c:if>>有发烧咳嗽症状</option>
						<option value="23" <c:if test="${user.roleId==23}">selected</c:if>>其他</option>
					</select>
				</div>
